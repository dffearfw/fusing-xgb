...
data = pd.read_excel('D:/pyworkspace/fusing xgb/src/pre-process/processed_data.xlsx')
...
train_dataset, val_dataset, test_dataset = init_dataset(data=data,
          ...
          'std_curvature2','std_high','std_aspect','glsnow','cswe','snow_depth_snow_depth','ERA5温度_ERA5温度','era5_swe','gldas',
